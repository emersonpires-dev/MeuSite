                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card h-100">
                           ...
                           <!-- <a href="#app-development" class="btn btn-primary">Saiba mais detalhes</a> -->
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card h-100">
                           ...
                           <!--<a href="#website-creation" class="btn btn-primary">Saiba mais detalhes</a> --> 
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="service-card h-100">
                          ...
                          <!--<a href="pages/delivery.html" class="btn btn-primary" target="_blank">Saiba mais detalhes</a> -->
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card h-100">
                           ...
                           <!-- <a href="#social-media" class="btn btn-primary">Saiba mais detalhes</a> -->
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card h-100">
                          ...
                          <!--  <a href="#google-adwords" class="btn btn-primary">Saiba mais detalhes</a> -->
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-card h-100">
                           ...
                           <!--<a href="#virtual-stores" class="btn btn-primary">Saiba mais detalhes</a> --> 
                        </div>
                    </div>
                </div>
            </div>
...
<div id="form-messages" class="mt-3"></div>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; 2025 InsideTec - Todos os direitos reservados.</p>
                </div>
